...
public class VenomMobEffect extends MobEffect {
	public VenomMobEffect() {
		...
		this.addAttributeModifier(Attributes.MOVEMENT_SPEED, ResourceLocation.fromNamespaceAndPath(DimesionaddonsMod.MODID, "effect.venom_1"), -0.0989, AttributeModifier.Operation.ADD_MULTIPLIED_BASE);
		...
		this.addAttributeModifier(Attributes.SNEAKING_SPEED, ResourceLocation.fromNamespaceAndPath(DimesionaddonsMod.MODID, "effect.venom_3"), -0.099, AttributeModifier.Operation.ADD_VALUE);
	}
